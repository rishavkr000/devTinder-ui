...
const Requests = () => {
  ...
  if (!requests) return <h2 className="flex justify-center my-10 font-bold"> No Request Found </h2>;

  if (requests.length == 0) return <h2 className="flex justify-center my-10 font-bold"> No Request Found </h2>;
  ...
  return (
    <div className="text-center my-10">
      ...
      {requests.map((request) => {
        ...
        if (!user) return null; // skip rendering if missing
